...
public class UsuarioCriacaoDTO {
    ...
    public UsuarioCriacaoDTO(String nomeUsuario, String senha, String telefone) {
        this.nomeUsuario = nomeUsuario;
        this.senha = senha;
        this.telefone = telefone;
    }

    public UsuarioCriacaoDTO(String nomeUsuario, String senha, String telefone, Perfil perfil) {
        this.nomeUsuario = nomeUsuario;
        this.senha = senha;
        this.telefone = telefone;
        this.perfil = perfil;
